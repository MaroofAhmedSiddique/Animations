 ...
 */
public class EmitterTimeLimitedActivity extends AppCompatActivity {
    ...
    protected void onCreate(@Nullable Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_emitter_timelimited);
        ...
        mClick.setOnClickListener(new View.OnClickListener() {
            ...
            public void onClick(View v) {
                ...
                ParticleSystem ps = new ParticleSystem(ct, 25, R.drawable.night, 1000);
